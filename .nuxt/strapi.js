...
class Strapi extends Hookable {
  constructor (ctx) {
    ...
    this.$http.setBaseURL(runtimeConfig.url || 'yonk-back.herokuapp.com/')
...
export default async function (ctx, inject) {
  [{"name":"articles","type":"collection"},{"name":"homepage","type":"single"},{"name":"info","type":"single"},{"name":"global","type":"single"}].forEach((entity) => {
  let key
  let type = 'collection'
